...
<div class="card">
    <div class="row">
        <div class="col">
            <h5 class="card-header">Socios</h5><p>
            <button
            type="button"
    ...
    <table id="example" class="display nowrap" style="width:100%">
      <thead>
          <tr>
            ...
            <th>Email<br><input type="text" class="form-control column_search" id="colSearch_razao"></th>
            <th>Telefone<br><input type="text" class="form-control column_search" id="colSearch_cnpj"></th>
            <th>Ações</th>
          </tr>
      </thead>
      <tbody>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a href="{{ route('editar_socio', ['id'=> $item->id]) }}"><i class="bx bx-edit-alt me-1"></i> Edit </a>
                    ...
                    <form id="delete-form-{{ $item->id }}" action="{{ route('socios.destroy', ['id'=> $item->id]) }}" method="POST" style="display: none;">
                    @csrf
                    @method('DELETE')
                </form>
                  </div>
...
<div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="row gy-3">
          <div class="col-md">
            ...
            <input type="text" id="email" name="email" class="form-control" placeholder="Enter Name" />
          </div>
        <div class="col-md">
  ...
  {{-- fim modal --}}
  <script src="../assets/js/mask_socio.js"></script>
  @endsection
